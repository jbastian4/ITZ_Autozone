...
#pragma config(Motor,  port2,            rbLiftMot,             tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port4,            tLiftMot,             tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port5,            goalMot,             tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port6,            lbLiftMot,             tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port8,            rbDriveMot,             tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port9,            lbDriveMot,             tmotorVex393_HBridge, openLoop)
